...
uint8_t L3G4200D_ReadReg(uint8_t Reg, uint8_t* Data) {
  ...
  *Data = SPI_Mems_Read_Reg(CS_L3G4200D, Reg );
...
* Return			: None
*******************************************************************************/
uint8_t L3G4200D_WriteReg(uint8_t Reg, uint8_t Data) {
    
  //To be completed with either I2c or SPI writing function
  SPI_Mems_Write_Reg(CS_L3G4200D,Reg, Data);
...
/*******************************************************************************
* Function Name  : L3G4200D_GetTemp
* Description    : Read the Temperature data Registers
* Input          : None
* Output         : Temperature buffer
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t L3G4200D_GetTemp(uint8_t* buff) {
  uint8_t value;
  if( !L3G4200D_ReadReg(L3G4200D_OUT_TEMP, &value) )
      return MEMS_ERROR;
  (*buff) = (uint8_t)value;
  return MEMS_SUCCESS;
}
