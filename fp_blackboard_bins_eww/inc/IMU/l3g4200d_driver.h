...
typedef uint8_t L3G4200D_Int1PinConf_t;
typedef uint8_t L3G4200D_Int2PinConf_t;
typedef uint8_t L3G4200D_Int1Conf_t;
typedef uint8_t L3G4200D_Axis_t;
...
typedef enum {  
  L3G4200D_ODR_100Hz_BW_12_5               =		0x00,
  L3G4200D_ODR_100Hz_BW_25			=		0x01,
  L3G4200D_ODR_200Hz_BW_12_5              =		0x04,
  L3G4200D_ODR_200Hz_BW_25		=		0x05,
  L3G4200D_ODR_200Hz_BW_50		=		0x06,
  L3G4200D_ODR_200Hz_BW_70		=		0x07,
  L3G4200D_ODR_400Hz_BW_20		=		0x08,
  L3G4200D_ODR_400Hz_BW_25		=		0x09,
  L3G4200D_ODR_400Hz_BW_50		=		0x0A,
  L3G4200D_ODR_400Hz_BW_110               =		0x0B,
  L3G4200D_ODR_800Hz_BW_30		=		0x0C,
  L3G4200D_ODR_800Hz_BW_35		=		0x0D,
  L3G4200D_ODR_800Hz_BW_50		=		0x0E,
  L3G4200D_ODR_800Hz_BW_110     	        =		0x0F
} L3G4200D_ODR_t;
...
#define L3G4200D_STATUS_REG_XDA                         0x00    // 0	:	a new data for the X-Axis is not available
...
status_t L3G4200D_SetInt1Threshold(L3G4200D_IntThsAxis axis, uint16_t ths);
status_t L3G4200D_SetInt1Duration(L3G4200D_Int1Conf_t id);

/*****************FIFO Functions******************/
status_t L3G4200D_FIFOModeEnable(L3G4200D_FifoMode_t fm);
status_t L3G4200D_SetWaterMark(uint8_t wtm);

/****************Reading Functions*****************/
status_t L3G4200D_GetSatusReg(uint8_t* buff);
status_t L3G4200D_GetAngRateRaw(L3GAxesRaw_t* buff);
status_t L3G4200D_GetFifoSourceReg(uint8_t* buff);
status_t L3G4200D_GetInt1Src(uint8_t* buff);
status_t L3G4200D_GetTemp(uint8_t* buff);

/*********************Generic*********************/
uint8_t L3G4200D_ReadReg(uint8_t Reg, uint8_t* Data);
uint8_t L3G4200D_WriteReg(uint8_t WriteAddr, uint8_t Data);
